 ...
 * Compile with:
 *
 * /Users/coleroberts/Documents/frida/build/frida_thin-macos-x86_64-clang -fPIC -Wall -Os -pipe -g3 frida-core-example.c -o frida-core-example -L. -lfrida-core -lbsm -lm -ldl -ldl -lresolv -lm -Wl,-framework,Foundation,-framework,AppKit -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.15.sdk -arch x86_64 -Wl,-dead_strip -L/Users/coleroberts/Documents/frida/build/frida_thin-macos-x86_64/lib -L/Users/coleroberts/Documents/frida/build/frida_thin-sdk-macos-x86_64/lib
 *
